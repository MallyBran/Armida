...
public class GameActual extends AppCompatActivity implements View.OnTouchListener {
    ...
    private void zmenaZadania1() { // toto je editovatelna metoda, tu možem pridavať koľko chcem zadani
        if(cisloZadania==1){
            zadanie.setText(zadania.ziskajArmida());
            sieste.setImageResource(R.drawable.mcblack);
            kamienky[5]= 2; // aby som vedel ktore budu cierne
            siedme.setImageResource(R.drawable.mcblack);
            kamienky[6]= 2;
            osme.setImageResource(R.drawable.mcblack);
            kamienky[7]= 2;
            teplotaZadanie = 5;// teplota zo zadania
            limitZvolenych=5;//pocet volnych policok na ktorych to musi hrac hrat
        }
        if(cisloZadania==2){
            onTextAppeared();//metoda ktora po 5 sekundach vymeni zadanie
        }
        if(cisloZadania==3){
            zadanie.setText(zadania.ziskajArmida2());
            //sieste.setImageResource(R.drawable.mcgrey);
            siedme.setImageResource(R.drawable.mcblack);
            kamienky[5]= 0;
            zresetovanieObrazkov();
            kamienky[6]= 2;
        ...
        if(cisloZadania==5){zadanie.setText(zadania.ziskajArmida3());
           // sieste.setImageResource(R.drawable.mcgrey);
           // siedme.setImageResource(R.drawable.mcgrey);
            kamienky[5]= 0;
            kamienky[6]= 0;
            zresetovanieObrazkov();
            osme.setImageResource(R.drawable.mcblack);
        ...
        if(cisloZadania==6){
            onTextAppeared();}
        if(cisloZadania==7){zadanie.setText(zadania.ziskajArmida4()); // zdroj textu zadania
            kamienky[5]= 0;
            kamienky[6]= 0;
            kamienky[7]= 0; // zresetovanie z minuleho zadania
            zresetovanieObrazkov();
            teplotaZadanie = 2;
            limitZvolenych=8;} // kolko je volnych
        if(cisloZadania==8){
            zadanie.setText("vyhral si");//metoda ktora po 4 sekundach vymeni zadanie
             }}
